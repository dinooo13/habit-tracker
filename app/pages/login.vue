...
<template>
  <UContainer class="py-16 md:py-24">
    <div class="mx-auto max-w-md">
      <UCard class="relative overflow-hidden border-default/70 bg-default/85 p-6 shadow-xl shadow-primary/10" variant="outline">
        <div class="pointer-events-none absolute -right-20 -top-20 h-40 w-40 rounded-full bg-primary/20 blur-2xl" aria-hidden="true" />
        ...
        <div class="relative z-10 space-y-6">
          <div class="space-y-2">
            ...
            <h1 class="text-3xl font-semibold tracking-tight">Continue to Atomic Habit Tracker</h1>
          ...
          <div class="space-y-3">
            ...
            <UButton class="w-full justify-center" size="xl" icon="i-lucide-log-in" @click="loginAndContinue">
              Continue with demo login
            </UButton>
            <UButton class="w-full justify-center" color="neutral" variant="outline" to="/">
              Back to landing
            </UButton>
          </div>
        </div>
